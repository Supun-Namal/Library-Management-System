...
{
    public partial class issuedbooksreport : Form
    {
        public issuedbooksreport()
        {
            InitializeComponent();
        }
        ...
        private void btnLoadReport_Click(object sender, EventArgs e)
        {
            ...
            string filePath = @"D:\New Project\Library Managment System\Report Files\Issued Books Report.txt"; // Replace with your desired file path
